...
public class HUDCuba : MonoBehaviour
{

    //First we declare all the components and variables that we will use in the code 

    public GameManagerCuba manager;
    public static HUDCuba instance;
    ...
    void Start()
    {
        ...
        GameManagerCuba.instance.points = points;
        UpdatePoints();
    ...
    {
        int points = GameManagerCuba.instance.points;
