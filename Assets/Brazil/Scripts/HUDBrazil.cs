...
public class HUDBrazil : MonoBehaviour
{

    //First we declare all the components and variables that we will use in the code 
    
    public GameManagerBrazil manager; 
    public static HUDBrazil instance;
    ...
    void Start()
    {
        ...
        GameManagerBrazil.instance.points = points;
        UpdatePoints();
    ...
    {
        int points = GameManagerBrazil.instance.points;
